...
contract ERC1155 is IERC1155{
    ...
    //acount and corresponding ids should be input in order
    ...
    //If to refers to a smart contract, it must implement ERC1155 receiver
    ...
    function _safeTransferFrom(address from,address to,uint256 id,uint256 amount,bytes memory data) internal virtual {
        ...
        //these are defined to generalise the batch transfer and single transfer
    ...
    //set the operator to transfer owners all the token to any address
